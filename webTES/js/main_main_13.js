        ...
        $(this).find('.selector-popup-launcher').click(function() {
            ...
            $(popupTarget + ' *[data-popup-action="accept"]').click(function() {
                $(popupTarget +' .treeView-branch.selected').each(function() {
                    ...
                    $('#category-selector').find('#category-selector-id').val(id).trigger('change');
                    $('#category-selector').find('#category-selector-title').val(title).trigger('change');
                });
                $.fancybox.close();
            });
        });
