    ...
    var a = {
        ...
        _bindOutCancel: function () {
            ...
            c.cancel.on("mouseleave.raty", function (d) {
                b(this).attr("class", c.opt.cancelOff);
                if (c.opt.mouseout) {
        ...
        _bindOverCancel: function () {
            ...
            c.cancel.on("mouseover.raty", function (d) {
                b(this).attr("class", c.opt.cancelOn);
                c.stars.attr("class", c.opt.starOff);
        ...
        _bindOver: function () {
            ...
            c.stars.on(e, function (g) {
                var h = parseInt($(this).attr("alt"), 10);
                if (c.opt.half) {
        ...
        _roundStars: function (e) {
            ...
            if (d > this.opt.round.down) {
                ...
                this.stars.eq(Math.ceil(e) - 1).attr("class", this.opt[c]);
            }
        },
        ...
        readOnly: function (c) {
            return this.each(function () {
                ...
                if (d.data("readonly") !== c) {
                    if (c) {
                        d.off(".raty").children("span").off(".raty");
                        a._lock.call(this);
                    } else {
                        a._binds.call(this);
                        a._unlock.call(this);
