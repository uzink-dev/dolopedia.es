 ...
 */
class ProunTemplate extends TwitterBootstrapTemplate
{
    static protected $defaultOptions = array(
        ...
        'dots_message'        => '&hellip;',
        'dots_href'           => '#',
        'css_container_class' => 'pagination pagination-centered custom-pagination',
        'css_prev_class'      => 'custom-pagination-left',
        'css_next_class'      => 'custom-pagination-right',
    ...
    {
        return sprintf('<div class="%s"><ul>%%pages%%</ul> %%previous%% %%next%% </div>',
    ...
    public function previousDisabled()
    {
        ...
        return $this->pageLinkWithTextAndClass($class, $href, $text);
    }
    ...
    {
        $linkClass = $class ? sprintf(' class="%s"', $class) : '';
