...
class EventoControllerTest extends WebTestCase
{
    ...
    public function testPageListWithLoggedUser()
    {
        // method
        ...
        // data in html
        $this->assertCount(1, $crawler->filter('h1:contains("Eventos")'));
    }

    public function testNewEventWithLoggedUser()
    {
        // method
        $crawler = $this->client->request(
            'GET',
        ...
        // data in html
        $this->assertCount(1, $crawler->filter('h1:contains("Nuevo Evento")'));
    }
}
