<?php
namespace Uzink\BackendBundle\Services;

use Azine\EmailBundle\Services\AzineTemplateProvider;
use Azine\EmailBundle\Services\TemplateProviderInterface;

class NewsletterTemplateProvider extends AzineTemplateProvider implements TemplateProviderInterface
{
    const GENERAL_EMAIL_TEMPLATE		= 'FrontBundle:Email:email.general';
