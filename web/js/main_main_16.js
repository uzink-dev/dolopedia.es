    ...
    $('*[data-toggle="selector-tooltip"]').each(function () {
      ...
      $(this).mouseenter(function () {
        ...
        if (!popper) {
          ...
          $tooltip.append($('<div>').addClass('user-name').text($reference.data('name')));

          $editUser = $('<div>').addClass('edit-button icon-data-edit');
          $tooltip.append($editUser);

          $usersList = $('<div>').addClass('user-list');
          ...
          $editUser.click(function () {
            ...
            $.getJSON($reference.data('url'), function (data) {
              ...
              var usersList = new List($usersList[0], options, data);
            });
          });
        }
      });
